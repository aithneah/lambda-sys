...
const GroupsComponent = (props) =>
    <RectangularContainer
        ...
        icon="team"
        buttons={() => <>
            <ButtonComponent title="Dodaj nowego studenta" style="buttonGradient" fontsize="2vh" />
            <ButtonComponent title="Dodaj nową grupę" style="buttonGradient" fontsize="2vh" />
        </>}>
        <table className="groupsComponentTable">
            ...
            <tr>
                ...
                <td className="groupsComponentTableButtons">
                    <ButtonComponent title="Przeglądaj postępy" style="buttonBlue" fontsize="1.5vh" />
                    <ButtonComponent title="Edytuj grupę" style="buttonGreen" fontsize="1.5vh" />
                    <ButtonComponent title="Usuń grupę" style="buttonRed" fontsize="1.5vh" />
